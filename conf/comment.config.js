...
module.exports = {
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'Marcos-EHA/NotionNext', // Repositorio donde se guardan los comentarios (PENDIENTE: activar Discussions en GitHub Settings)
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || '', // PENDIENTE: obtener en https://giscus.app
  ...
  COMMENT_GISCUS_LANG: process.env.NEXT_PUBLIC_COMMENT_GISCUS_LANG || 'es', // tu Giscus idioma e.g 'en', 'zh-TW', 'zh-CN', 'es'
  ...
  COMMENT_VALINE_PLACEHOLDER:
    process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || 'Deja un comentario 😊', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
